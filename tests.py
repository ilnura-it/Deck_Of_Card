...
from deck_of_card import Card, Deck
...
class CardTests(unittest.TestCase):
   ...
   def test_repr(self):
      """repl should return a string of the form 'VALUE of SUIT'"""
...
class DeckTests(unittest.TestCase):
   def setUp(self):
      self.deck = Deck()
   def test_init(self):
      """decks should have a cards attribute, which is a list with 52"""
   ...
   def test_deal_sufficient_cards(self):
      """_dealshould deal the number of cards specified, """
      cards = self.deck._deal(10)
      self.assertEqual(len(cards), 10)
      self.assertEqual(self.deck.count(), 42)
   def test_deal_insufficient_cards(self):
      """_dealshould deal the number of cards left in the deck"""
